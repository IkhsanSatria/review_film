              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Edit Data Film</h4>
                  </div>
                  <div class="card-body">


				 <!-- ------------------------------------------------------------------------------ -->
<form action="<?php echo base_url('admin/film/edit/'.$film['id_film']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
...
<div class="form-group row">
	...
	<div class="col-md-2">
		<a href="<?php echo base_url('admin/film') ?>" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Kembali</a>
	</div>
	<div class="col-md-2">
