...
<?php 
echo form_open(base_url('admin/user/admin'), ['method' => 'post']); 
echo csrf_field(); 
?>
<div class="modal fade" id="modal-default">
    ...
    <div class="col-9">
        <select name="role" class="form-control" required>
            ...
            <option value="subscriber" <?php echo (set_value('role') == 'subscriber') ? 'selected' : ''; ?>>Subscriber</option>
            <option value="author" <?php echo (set_value('role') == 'author') ? 'selected' : ''; ?>>Author</option>
        </select>
    </div>
</div>
